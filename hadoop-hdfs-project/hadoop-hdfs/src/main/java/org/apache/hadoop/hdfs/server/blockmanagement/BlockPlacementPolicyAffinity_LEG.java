...
public class BlockPlacementPolicyAffinity_LEG extends BlockPlacementPolicy{
    ...
    public BlockPlacementPolicyAffinity_LEG() {
    ...
    public DatanodeStorageInfo[] chooseTarget(String srcPath,
        ...
        LOG.info("TODO ALL srcPath = {}, numOfReplicas = {}, " +
                "writer = {}, chosen = {}, returnChosenNodes = {}, " +
                "excludedNode = {}, blocksize = {}, storagePolicy {}"
                , srcPath, numOfReplicas, writer.getName(), chosen.size(),
                returnChosenNodes, excludedNodes.size(), blocksize, storagePolicy.toString());
...
//        String clientIP = ((DatanodeDescriptor) writer).getIpAddr();
        ...
        LOG.info("WRITER LEVEL {}, NAME {}, ", writer.getLevel(),writer.getName());
//        String clientIP = extractIPAddress(writer.getNetworkLocation());
        String clientIP = writer.getName();
...
//            return getPipeline(writer, clientToDataNodesMap.get(clientIP));
        ...
        for (DatanodeStorageInfo storageInfo : chosen) {
            LOG.info("STORAGE INFO = {}", storageInfo.toString());
            DatanodeDescriptor datanode = storageInfo.getDatanodeDescriptor();
            LOG.info("DN IP = {}", datanode.getIpAddr());
...
//    private String extractIPAddress(String networkLocation) {
//        LOG.info("TEST NETWORK LOCATION = {}", networkLocation);
//        InetSocketAddress socketAddress = new InetSocketAddress(networkLocation, 0);
